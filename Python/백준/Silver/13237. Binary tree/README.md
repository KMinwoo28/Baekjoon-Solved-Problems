...
<p><img alt="" src="" style="float:right; height:169px; width:250px">Check the following tree:</p>
...
<p><img alt="" src="" style="float:right; height:250px; width:228px">The following tree is a bit different:</p>
